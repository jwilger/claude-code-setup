...
description: ADVISORY AGENT - Step 12 - Guides completeness validation for entire event model. Returns recommendations to main conversation for collaborative event model creation. NO file editing.
