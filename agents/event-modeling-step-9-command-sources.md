...
description: ADVISORY AGENT - Step 9 - Guides command data source documentation. Returns recommendations to main conversation for collaborative event model creation. NO file editing.
