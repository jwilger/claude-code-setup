...
description: ADVISORY AGENT - Step 6 - Guides query and projection definition for UI screens. Returns recommendations to main conversation for collaborative event model creation. NO file editing.
