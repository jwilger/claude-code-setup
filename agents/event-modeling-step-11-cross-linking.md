...
description: ADVISORY AGENT - Step 11 - Guides cross-link establishment between component documents. Returns recommendations to main conversation for collaborative event model creation. NO file editing.
