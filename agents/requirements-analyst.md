...
description: ADVISORY AGENT - Guides collaborative requirements analysis. Helps define WHAT software should do and WHY through discussion with user. Returns recommendations to main conversation for collaborative documentation. NO file editing.
